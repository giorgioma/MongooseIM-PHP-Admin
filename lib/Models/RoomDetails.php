...
class RoomDetails implements ArrayAccess
{
    ...
    /**
     * Sets id
     * @param string $id The leading part of the room's JID. If the ID is \"marmoreal\" and the XMPP hostname is \"wonderland\" then the JID is \"marmoreal@wonderland\".
     * @return $this
     */
    ...
    /**
     * Sets owner
     * @param string $owner The user's JID on whose behalf to create the room
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name The name of the room. **NOT** the room's JID. This is the name that goes into the room's configuration.
     * @return $this
     */
    ...
    /**
     * Sets subject
     * @param string $subject Room's initial subject
     * @return $this
     */
