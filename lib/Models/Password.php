 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Password implements ArrayAccess
{
    /**
    ...
    {
        $this->container['newpass'] = isset($data['newpass']) ? $data['newpass'] : null;
    }
    ...
    {
        $this->container['newpass'] = $newpass;
